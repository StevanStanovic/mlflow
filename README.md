...
2. * `pip install --user --upgrade nom_bibliothèque` pour ceux ayant installer Python
2. * `conda install --user --upgrade nom_bibliothèque` pour ceux ayant installer Anaconda
